...
def aantal_kluizen_vrij(data = "testkluizen.txt"):
...
def nieuwe_kluis(bestand = "testkluizen.txt"):
...
def kluis_openen(data = "testkluizen.txt"):
    try:
...
def kluis_teruggeven(data = "testkluizen.txt"):
...
# dit is voor de menu om de functies aan te roepen voor de tests kan dit uitgekoment zijn!
# while True:
#     print(50 * "=")
